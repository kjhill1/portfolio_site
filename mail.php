...
try {
    ...
    $mail->Username = 'kj@kellyjhill.design';             // SMTP username
    $mail->Password = 'SevenSites1!';                           // SMTP password
    $mail->SMTPSecure = 'ssl';                            // Enable SSL encryption, TLS also accepted with port 465
    $mail->Port = 465;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('kj@kellyjhill.design', 'Mailer');          //This is the email your form sends From
    $mail->addAddress('kj@kellyjhill.design', 'Kelly J Hill'); // Add a recipient address
